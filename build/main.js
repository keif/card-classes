...
class Deck {
	...
	makeDeck() {
		...
		this.deck = CARD_SUITS.map((suitVal, suitIdx, suitArr) =>
			CARD_RANKS.map((rankVal, rankIdx, rankArr) => new _Card__WEBPACK_IMPORTED_MODULE_0__["default"](rankVal, suitVal))
		);
	}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_Deck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/Deck */ "./src/components/Deck.js");


console.table(playAGame());

function playAGame() {
    const deckOfCards = new _components_Deck__WEBPACK_IMPORTED_MODULE_0__["default"]();
    try {
